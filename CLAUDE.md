...
- Redesigned the bill payment user journey across 3 mobile apps and 2 websites — mapped
  how billers communicate with customers and identified core friction: customers were
  required to enter a 17-character biller account ID they rarely had to hand, when their
  registered mobile number was a sufficient lookup key; removed redundant fields,
  prioritised information the customer actually holds at payment time, and auto-populated
  account details on identifier entry; drove **400% new user registration growth** and
  **300% transaction volume growth** for Pockets and BBPS
- Launched auto-pay feature — customers could connect a preferred credit/debit card or
  bank account and schedule automatic payments 2 days before the bill-due date per biller
  category; drove recurring engagement without requiring active re-acquisition
- Defined the Wallet-as-a-Service (WaaS) API contract and integration specifications for
  neobank and startup partners — owned developer experience end-to-end, treating external
  engineering teams as the primary customer; unlocked a new B2B distribution channel with
  zero incremental CAC
- Managed 100+ operational wallet and payment incidents end-to-end — balance discrepancy
  investigations, failed reconciliation events, settlement delays; **zero major SLA
  breaches**
...
- Senior Product Manager — Payments, Fraud & Risk
- Senior Product Manager — Payments & Wallet
- Senior Product Manager — iGaming / Payments
- Senior Product Manager — iGaming / Monetization
...
| Pockets wallet user growth | **400%** new user registrations | ICICI Bank — bill pay UX redesign (3 apps, 2 websites) |
| Pockets transaction volume growth | **300%** | ICICI Bank — bill pay UX redesign (3 apps, 2 websites) |
